...
export const INVALID_CONSUMER_LEASE_TUPLES = [
  ...
  { name: "scrape-time source marked publishing", source: "scrape_time", leaseExpiresAt: "2026-08-07T12:00:00.000Z", attemptState: "mutation_started", publicationState: "publishing", publicationClaimToken: "publication-token", terminalFailureReason: null },
  { name: "scrape-time source marked cancelled", source: "scrape_time", leaseExpiresAt: "2026-08-07T12:00:00.000Z", attemptState: "mutation_started", publicationState: "cancelled", publicationClaimToken: null, terminalFailureReason: null },
